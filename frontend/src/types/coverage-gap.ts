...
export interface CoverageGap {
  ...
  overlap_ratio:number; processing_millis:number; version:number; due_at:string|null; assignee_id?:number|null; claimed_at?:string|null; detected_at:string; updated_at:string
  survey_area?:SurveyArea; assignee?:UserIdentity|null
}
